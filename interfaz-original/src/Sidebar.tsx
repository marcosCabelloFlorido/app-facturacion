...
import './sidebar.css';
import kronjopSymbol from './assets/kronjop-symbol.png';
      ...
      >
        <div className="sidebar-heading">
          <a
            ...
            href="#overview"
            aria-label="Kronjop · Inicio"
            onClick={() => {
              if (narrow && current === 'overview') closeMenu();
            }}
          >
            <span className="sidebar-icon">
              <img src={kronjopSymbol} alt="" className="sidebar-brand-symbol" />
            </span>
            <span className="sidebar-label">
              kronjop<span className="brand-dot">.</span>
            </span>
          </a>
          {narrow && (
            <button
